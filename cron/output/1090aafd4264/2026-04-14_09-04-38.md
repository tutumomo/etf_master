...
- 觀察標的：0050（80.60, RSI 62.4）、006208（RSI 62.6）、00679B（RSI 44.4）
- **異動事件：有** — L3重大旗標觸發（00687B/00694B/00720B 已下市無報價），共20項異常
- **體制變動：有** — cautious→**bullish**，elevated→**normal**（技術面改善：均RSI 60.3、MACD 多頭、14/15檔站上月線；共識仲裁 Tier2，降級執行 buy-preview 00923）
