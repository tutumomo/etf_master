...
- 0050 84.65（+1.87%）偏多震盪｜006208 196.10（+2.11%）｜0056 40.78（+2.05%）🔥強勢
- 體制與風險訊號無異動（cautious / elevated 維持，RSI 67.2→67.3 微幅波動）
- 決策引擎：AI hold vs 規則 buy 00830（Tier 2 降級，preview-only）
