...
- 觀察標的：0050 84.65（+5.02%）、006208 196.15（+4.92%）、00878 23.47（+2.00%）
- **異動事件：L3 資料完整性異常觸發**；00687B、00694B、00720B 無有效報價
- 補充風險：00892 RSI 偏高；中東封鎖/能源運輸事件仍在活躍清單
- Wiki 已更新：market-view.md、risk-signal.md
